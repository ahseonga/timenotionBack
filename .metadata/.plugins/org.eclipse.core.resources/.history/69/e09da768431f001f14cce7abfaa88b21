...
INSERT INTO GGHJ_USER (USER_ID, USER_NAME, USER_PASSWORD, USER_EMAIL, USER_NICKNAME, USER_BIRTH)
VALUES (6, '송아성', 'password123', 'koreaIT@naver.com', 'johnny2', TO_DATE('1990-01-01', 'YYYY-MM-DD'));

INSERT INTO GGHJ_USER (USER_ID, USER_NAME, USER_PASSWORD, USER_EMAIL, USER_NICKNAME, USER_BIRTH)
VALUES (7, '장윤근', 'password123', 'korea1IT@naver.com', 'jang', TO_DATE('1999-01-01', 'YYYY-MM-DD'));

INSERT INTO GGHJ_USER (USER_ID, USER_NAME, USER_PASSWORD, USER_EMAIL, USER_NICKNAME, USER_BIRTH)
VALUES (8, '윤담', 'password123', 'korea2IT@naver.com', 'dam', TO_DATE('1998-01-01', 'YYYY-MM-DD'));

INSERT INTO GGHJ_USER (USER_ID, USER_NAME, USER_PASSWORD, USER_EMAIL, USER_NICKNAME, USER_BIRTH)
VALUES (9, '고태민', 'password123', 'korea3IT@naver.com', 'taemin', TO_DATE('1998-01-01', 'YYYY-MM-DD'));

INSERT INTO GGHJ_USER (USER_ID, USER_NAME, USER_PASSWORD, USER_EMAIL, USER_NICKNAME, USER_BIRTH)
VALUES (10, '문동주', 'password123', 'korea4IT@naver.com', 'dongju', TO_DATE('1999-01-01', 'YYYY-MM-DD'));
...
INSERT INTO GGHJ_UNI (UNI_ID, UNI_STATUS, UNI_ABOUT, USER_ID, KAKAO_ID)
VALUES (6, '일반', 'Inactive user profile', 6, null);

INSERT INTO GGHJ_UNI (UNI_ID, UNI_STATUS, UNI_ABOUT, USER_ID, KAKAO_ID)
VALUES (7, '일반', 'Inactive user profile', 7, null);

INSERT INTO GGHJ_UNI (UNI_ID, UNI_STATUS, UNI_ABOUT, USER_ID, KAKAO_ID)
VALUES (8, '일반', 'Inactive user profile', 8, null);

INSERT INTO GGHJ_UNI (UNI_ID, UNI_STATUS, UNI_ABOUT, USER_ID, KAKAO_ID)
VALUES (9, '일반', 'Inactive user profile', 9, null);

INSERT INTO GGHJ_UNI (UNI_ID, UNI_STATUS, UNI_ABOUT, USER_ID, KAKAO_ID)
VALUES (10, '일반', 'Inactive user profile', 10, null);
...
VALUES (1, 'My First Post', 'This is the content of my first post.', 'O', SYSDATE, SYSDATE, 0, '청소년기', 1, 2024, 1);

INSERT INTO GGHJ_BOARD (BOARD_ID, BOARD_TITLE, BOARD_CONTENT, BOARD_PUBLIC, BOARD_CREATED_DATE, BOARD_UPDATED_DATE, BOARD_VIEW_COUNT, BOARD_LIFE_CYCLE, BOARD_LIKE_COUNT, BOARD_YEAR, USER_ID)
VALUES (2, 'A Day in the Life', 'Today I want to share what a typical day looks like for me.', 'X', SYSDATE, SYSDATE, 0, '청년', 2, 2024, 2);

UPDATE GGHJ_BOARD
SET BOARD_VIEW_COUNT = 2
WHERE BOARD_ID = 2;

INSERT INTO GGHJ_BOARD (BOARD_ID, BOARD_TITLE, BOARD_CONTENT, BOARD_PUBLIC, BOARD_CREATED_DATE, BOARD_UPDATED_DATE, BOARD_VIEW_COUNT, BOARD_LIFE_CYCLE, BOARD_LIKE_COUNT, BOARD_YEAR, USER_ID)
VALUES (3, 'Reflections', 'Reflecting on the past few years and what I have learned.', 'O', SYSDATE, SYSDATE, 0, '중년', 3, 2024, 1);

UPDATE GGHJ_BOARD
SET BOARD_VIEW_COUNT = 3
WHERE BOARD_ID = 3;

INSERT INTO GGHJ_BOARD (BOARD_ID, BOARD_TITLE, BOARD_CONTENT, BOARD_PUBLIC, BOARD_CREATED_DATE, BOARD_UPDATED_DATE, BOARD_VIEW_COUNT, BOARD_LIFE_CYCLE, BOARD_LIKE_COUNT, BOARD_YEAR, USER_ID)
VALUES (4, 'Travel Diaries', 'Sharing my travel experiences and adventures.', 'O', SYSDATE, SYSDATE, 0, '전성기', 4, 2024, 4);

UPDATE GGHJ_BOARD
SET BOARD_VIEW_COUNT = 4
WHERE BOARD_ID = 4;

INSERT INTO GGHJ_BOARD (BOARD_ID, BOARD_TITLE, BOARD_CONTENT, BOARD_PUBLIC, BOARD_CREATED_DATE, BOARD_UPDATED_DATE, BOARD_VIEW_COUNT, BOARD_LIFE_CYCLE, BOARD_LIKE_COUNT, BOARD_YEAR, USER_ID)
VALUES (5, 'Family Memories', 'Cherishing the moments spent with family.', 'X', SYSDATE, SYSDATE, 0, '노년', 5, 2024, 5);

UPDATE GGHJ_BOARD
SET BOARD_VIEW_COUNT = 5
WHERE BOARD_ID = 5;
SELECT * FROM GGHJ_BOARD gb ;
SELECT * FROM GGHJ_USER;
SELECT * FROM GGHJ_UNI;
INSERT INTO GGHJ_BOARD (BOARD_ID, BOARD_TITLE, BOARD_CONTENT, BOARD_PUBLIC, BOARD_CREATED_DATE, BOARD_UPDATED_DATE, BOARD_VIEW_COUNT, BOARD_LIFE_CYCLE, BOARD_LIKE_COUNT, BOARD_YEAR, USER_ID)
VALUES (6, '코딩이란?', '안녕하세요', 'X', SYSDATE, SYSDATE, 0, '전성기', 2, 2024, 6);

DELETE FROM GGHJ_BOARD WHERE BOARD_ID = 6;

INSERT INTO GGHJ_BOARD (BOARD_ID, BOARD_TITLE, BOARD_CONTENT, BOARD_PUBLIC, BOARD_CREATED_DATE, BOARD_UPDATED_DATE, BOARD_VIEW_COUNT, BOARD_LIFE_CYCLE, BOARD_LIKE_COUNT, BOARD_YEAR, USER_ID)
VALUES (7, '코딩이란?', '안녕하세요', 'X', SYSDATE, SYSDATE, 0, '전성기', 2, 2024, 7);

DELETE FROM GGHJ_BOARD WHERE BOARD_ID = 10;

INSERT INTO GGHJ_BOARD (BOARD_ID, BOARD_TITLE, BOARD_CONTENT, BOARD_PUBLIC, BOARD_CREATED_DATE, BOARD_UPDATED_DATE, BOARD_VIEW_COUNT, BOARD_LIFE_CYCLE, BOARD_LIKE_COUNT, BOARD_YEAR, USER_ID)
VALUES (8, '자바란?', '코리아IT카데미카미', 'X', SYSDATE, SYSDATE, 0, '전성기', 30, 2024, 8);

INSERT INTO GGHJ_BOARD (BOARD_ID, BOARD_TITLE, BOARD_CONTENT, BOARD_PUBLIC, BOARD_CREATED_DATE, BOARD_UPDATED_DATE, BOARD_VIEW_COUNT, BOARD_LIFE_CYCLE, BOARD_LIKE_COUNT, BOARD_YEAR, USER_ID)
VALUES (9, 'JS란?', '코리아IT카데미카미', 'X', SYSDATE, SYSDATE, 0, '전성기', 20, 2024, 9);

INSERT INTO GGHJ_BOARD (BOARD_ID, BOARD_TITLE, BOARD_CONTENT, BOARD_PUBLIC, BOARD_CREATED_DATE, BOARD_UPDATED_DATE, BOARD_VIEW_COUNT, BOARD_LIFE_CYCLE, BOARD_LIKE_COUNT, BOARD_YEAR, USER_ID)
VALUES (10, 'JSP?', '코리아IT카데미카란미', 'X', SYSDATE, SYSDATE, 0, '전성기', 25, 2024, 10);

INSERT INTO GGHJ_BOARD (BOARD_ID, BOARD_TITLE, BOARD_CONTENT, BOARD_PUBLIC, BOARD_CREATED_DATE, BOARD_UPDATED_DATE, BOARD_VIEW_COUNT, BOARD_LIFE_CYCLE, BOARD_LIKE_COUNT, BOARD_YEAR, USER_ID)
VALUES (10, 'JSP?', '코리아IT아카데미', 'X', SYSDATE, SYSDATE, 0, '전성기', 25, 2024, 4);
