...
SELECT BOARD_ID, BOARD_TITLE, BOARD_CONTENT, BOARD_CREATED_DATE, BOARD_UPDATED_DATE, BOARD_VIEW_COUNT, BOARD_LIFE_CYCLE, BOARD_YEAR, USER_ID
	...
	FROM ( SELECT B.BOARD_ID, B.BOARD_TITLE, B.BOARD_CONTENT, B.BOARD_CREATED_DATE, B.BOARD_UPDATED_DATE, B.BOARD_VIEW_COUNT, B.BOARD_LIFE_CYCLE, B.BOARD_YEAR, U.USER_ID
			FROM GGHJ_BOARD B JOIN GGHJ_USER U ON B.USER_ID = U.USER_ID
		LEFT JOIN ()	
