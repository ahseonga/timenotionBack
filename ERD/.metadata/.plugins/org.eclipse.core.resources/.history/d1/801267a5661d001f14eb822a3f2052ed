...
VALUES (1, 'Inappropriate content', SYSDATE, 1, 201, 1, 1);

INSERT INTO GGHJ_REPORT (REPORT_ID, REPORT_REASON, REPORT_CREATED_DATE, REPORT_COUNT, USER_ID, REPLY_ID, COMMENT_ID)
VALUES (2, 'Harassment', SYSDATE, 1, 202, 2, 2);

INSERT INTO GGHJ_REPORT (REPORT_ID, REPORT_REASON, REPORT_CREATED_DATE, REPORT_COUNT, USER_ID, REPLY_ID, COMMENT_ID)
VALUES (3, 'Spam', SYSDATE, 1, 203, 3, 3);

INSERT INTO GGHJ_REPORT (REPORT_ID, REPORT_REASON, REPORT_CREATED_DATE, REPORT_COUNT, USER_ID, REPLY_ID, COMMENT_ID)
VALUES (4, 'Offensive language', SYSDATE, 1, 204, 4, 4);

INSERT INTO GGHJ_REPORT (REPORT_ID, REPORT_REASON, REPORT_CREATED_DATE, REPORT_COUNT, USER_ID, REPLY_ID, COMMENT_ID)
VALUES (5, 'False information', SYSDATE, 1, 205, 5, 5);
